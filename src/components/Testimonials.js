      ...
      <div className="container-width">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="card p-6 relative hover:scale-105 transition-all duration-300">
              {/* Quote Icon */}
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-700">
                <div className="flex items-center">
                  <div className={`w-12 h-12 ${testimonial.image} rounded-full mr-4 flex items-center justify-center`}>
        ...
        <div className="text-center mt-16">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold mb-4 text-blue-400">Ready to Work Together?</h3>
